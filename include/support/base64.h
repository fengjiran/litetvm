...
#ifndef LITETVM_SUPPORT_BASE64_H
#define LITETVM_SUPPORT_BASE64_H
...
public:
   ...
   */
    ...
    bool IsEOF() const { return num_prev_ == 0 && (temp_ch_ == EOF || isspace(temp_ch_)); }
...
#endif//LITETVM_SUPPORT_BASE64_H
