...
#ifndef LITETVM_RUNTIME_THREADING_BACKEND_H
#define LITETVM_RUNTIME_THREADING_BACKEND_H
...
template<typename T>
void parallel_launch_with_threading_backend(T flambda) {
...
#endif//LITETVM_RUNTIME_THREADING_BACKEND_H
