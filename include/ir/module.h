...
#ifndef LITETVM_IR_MODULE_H
#define LITETVM_IR_MODULE_H
...
public:
   ...
   */
    ...
    LITETVM_API bool SEqualReduce(const IRModuleNode* other, SEqualReducer equal) const;
   ...
   * environment.
   */
    LITETVM_API void Add(const GlobalVar& var, const BaseFunc& func, bool update = false);
   ...
   */
    LITETVM_API void AddUnchecked(const GlobalVar& var, const BaseFunc& func);
   ...
   */
    LITETVM_API void Update(const GlobalVar& var, const BaseFunc& func);
   ...
   */
    LITETVM_API void UpdateGlobalInfo(const String& name, const Array<GlobalInfo>& info);

    /*!
   * \brief Remove a function from the global environment.
   * \param var The name of the global function to update.
   */
    LITETVM_API void Remove(const GlobalVar& var);
   ...
   */
    LITETVM_API bool ContainGlobalVar(const String& name) const;
   ...
   */
    LITETVM_API GlobalVar GetGlobalVar(const String& str) const;
   ...
   */
    LITETVM_API Array<GlobalVar> GetGlobalVars() const;
   ...
   */
    LITETVM_API BaseFunc Lookup(const GlobalVar& var) const;
   ...
   */
    LITETVM_API BaseFunc Lookup(const String& name) const;
   ...
   */
    LITETVM_API void Update(const IRModule& other);

    /*!
   * \brief Create a shallow copy of this IRModule.
   * \returns The shallow copy of the IRModule.
   */
    LITETVM_API IRModule ShallowCopy();
    /*!
   * \brief The set of imported files.
   */
    LITETVM_API std::unordered_set<String> Imports() const;
...
public:
  ...
  */
    LITETVM_API explicit IRModule(Map<GlobalVar, BaseFunc> functions,
  ...
  * imports.
  */
    LITETVM_API static IRModule FromExpr(const RelaxExpr& expr,
