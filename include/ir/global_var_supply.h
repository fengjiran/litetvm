...
#ifndef LITETVM_IR_GLOBAL_VAR_SUPPLY_H
#define LITETVM_IR_GLOBAL_VAR_SUPPLY_H
...
public:
   ...
   * \param name_to_var_map An optional map.
   */
    LITETVM_API explicit GlobalVarSupply(const NameSupply& name_supply = NameSupply(),
                                     std::unordered_map<std::string, GlobalVar> name_to_var_map = {});
   ...
   * of IRModules.
   */
    LITETVM_API explicit GlobalVarSupply(const Array<IRModule>& modules);
   ...
   * IRModule.
   */
    LITETVM_API explicit GlobalVarSupply(const IRModule module);
...
#endif//LITETVM_IR_GLOBAL_VAR_SUPPLY_H
