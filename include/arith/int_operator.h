...
#ifndef LITETVM_ARITH_INT_OPERATOR_H
#define LITETVM_ARITH_INT_OPERATOR_H
...
bool WillOverflow(int64_t x, int64_t y, int64_t min_value, int64_t max_value) {
    return false;
}
...
#endif//LITETVM_ARITH_INT_OPERATOR_H
