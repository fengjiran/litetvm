...
#ifndef LITETMV_ARITH_REWRITE_SIMPLIFY_H
#define LITETMV_ARITH_REWRITE_SIMPLIFY_H
...
protected:
    ...
    void RecordRewrite() {
        ...
        CHECK(maximum_rewrite_steps_ <= 0 || stats_.rewrites_performed <= maximum_rewrite_steps_)
...
#endif//LITETMV_ARITH_REWRITE_SIMPLIFY_H
