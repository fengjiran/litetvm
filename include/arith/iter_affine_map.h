...
#ifndef LITETVM_ARITH_ITER_AFFINE_MAP_H
#define LITETVM_ARITH_ITER_AFFINE_MAP_H
...
public:
   ...
   */
    LITETVM_API IterMark(PrimExpr source, PrimExpr extent);
...
public:
   ...
   * \param source The source expression.
   */
    LITETVM_API explicit IterSplitExpr(IterMark source);
    /*!
   * \brief constructor from just source.
   * \param source The source expression.
   * \param scale The additional scaling factor.
   */
    LITETVM_API explicit IterSplitExpr(IterMark source, PrimExpr scale);
    /*!
   * \brief constructor
   * \param source The source expression.
   ...
   * \param scale The additional scaling factor.
   */
    LITETVM_API explicit IterSplitExpr(IterMark source, PrimExpr lower_factor, PrimExpr extent,
                                       PrimExpr scale);
...
public:
   ...
   */
    LITETVM_API IterSumExpr(Array<IterSplitExpr> args, PrimExpr base);
...
public:
    // constructor
    IterMapResult() { data_ = runtime::make_object<IterMapResultNode>(); }
...
#endif//LITETVM_ARITH_ITER_AFFINE_MAP_H
