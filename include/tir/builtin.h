 ...
 */
LITETVM_API const Op& reinterpret();

/*!
 * \brief Marks a condition is likely going to happen.
 */
LITETVM_API const Op& likely();

/*!
 * \brief Bitwise and operator.
 */
LITETVM_API const Op& bitwise_and();

/*!
 * \brief Bitwise or operator.
 */
LITETVM_API const Op& bitwise_or();

/*!
 * \brief Bitwise xor operator.
 */
LITETVM_API const Op& bitwise_xor();

/*!
 * \brief Bitwise not operator.
 */
LITETVM_API const Op& bitwise_not();

/*!
 * \brief Left shift
 */
LITETVM_API const Op& shift_left();

/*!
 * \brief Right shift
 */
LITETVM_API const Op& shift_right();
 ...
 *  }
 */
LITETVM_API const Op& large_uint_imm();
 ...
 */
LITETVM_API const Op& q_multiply_shift();
 ...
 *  }
 */
LITETVM_API const Op& address_of();
 ...
 *  }
 */
LITETVM_API const Op& if_then_else();
 ...
 *  }
 */
LITETVM_API const Op& isnullptr();

/*!
 * \brief Check if value is nan
 */
LITETVM_API const Op& isnan();

/*!
 * \brief Popcount
 */
LITETVM_API const Op& popcount();
 ...
 */
LITETVM_API const Op& call_extern();
 ...
 *       Always consider use pre-registered and typed tvm::Op first.
 */
LITETVM_API const Op& call_pure_extern();
 ...
 */
LITETVM_API const Op& call_llvm_intrin();
 ...
 * \note This op does not provide any type checking.
 */
LITETVM_API const Op& call_llvm_pure_intrin();
 ...
 * \note This op does not provide any type checking.
 */
LITETVM_API const Op& call_spirv_pure_glsl450();
 ...
 *  }
 */
LITETVM_API const Op& tvm_access_ptr();
 ...
 */
LITETVM_API const Op& tvm_static_handle();
 ...
 */
LITETVM_API const Op& tvm_context_id();
 ...
 */
LITETVM_API const Op& tvm_tuple();
 ...
 */
LITETVM_API const Op& tvm_struct_get();
 ...
 * \sa TVMStructFieldKind
 */
LITETVM_API const Op& tvm_struct_set();
 ...
 * }
 */
LITETVM_API const Op& lookup_param();
 ...
 *  }
 */
LITETVM_API const Op& tvm_throw_last_error();
 ...
 *  }
 */
LITETVM_API const Op& tvm_stack_alloca();
 ...
 *  }
 */
LITETVM_API const Op& tvm_stack_make_shape();
 ...
 *  }
 */
LITETVM_API const Op& tvm_stack_make_array();
 ...
 *  }
 */
LITETVM_API const Op& tvm_call_packed();
 ...
 *  }
 */
LITETVM_API const Op& tvm_call_cpacked();
 ...
 *  }
 */
LITETVM_API const Op& tvm_call_trace_packed();
 ...
 *  }
 */
LITETVM_API const Op& tvm_check_return();
 ...
 *  }
 */
LITETVM_API const Op& tvm_call_packed_lowered();
 ...
 *  }
 */
LITETVM_API const Op& tvm_call_cpacked_lowered();
 ...
 *  }
 */
LITETVM_API const Op& tvm_call_trace_packed_lowered();
 ...
 *  }
 */
LITETVM_API const Op& tvm_storage_sync();
 ...
 *
 */
LITETVM_API const Op& tvm_warp_shuffle();
LITETVM_API const Op& tvm_warp_shuffle_up();
LITETVM_API const Op& tvm_warp_shuffle_down();
LITETVM_API const Op& tvm_warp_activemask();

/*!
 * \brief Initialize the global barrier.
 *  Call this at beginning of kernel that need global barrier.
 */
LITETVM_API const Op& tvm_global_barrier_kinit();
 ...
 *  }
 */
LITETVM_API const Op& tvm_thread_allreduce();
 ...
 *  }
 */
LITETVM_API const Op& tvm_load_matrix_sync();
 ...
 *  }
 */
LITETVM_API const Op& tvm_mma_sync();
 ...
 *  }
 */
LITETVM_API const Op& tvm_bmma_sync();
 ...
 *  }
 */
LITETVM_API const Op& tvm_fill_fragment();
 ...
 *  }
 */
LITETVM_API const Op& tvm_store_matrix_sync();
 ...
 */
LITETVM_API const Op& ptx_mma_sp();
 ...
 */
LITETVM_API const Op& ptx_ldmatrix();
 ...
 *                   size_t bytes);
 */
LITETVM_API const Op& ptx_cp_async();
 ...
 *                   int barrier_id);
 */
LITETVM_API const Op& ptx_cp_async_bulk();
 ...
 *
 */
LITETVM_API const Op& ptx_commit_group();
LITETVM_API const Op& ptx_wait_group();
 ...
 *
 */
LITETVM_API const Op& ptx_cp_async_barrier();
 ...
 *
 */
LITETVM_API const Op& ptx_init_barrier_thread_count();
 ...
 *
 */
LITETVM_API const Op& ptx_arrive_barrier();
 ...
 *
 */
LITETVM_API const Op& ptx_arrive_barrier_expect_tx();
 ...
 *
 */
LITETVM_API const Op& ptx_wait_barrier();
 ...
 *
 */
LITETVM_API const Op& create_barriers();
 ...
 */
LITETVM_API const Op& mma_store();
 ...
 *                                   int col = 8, int row = 8);
 */
LITETVM_API const Op& make_filled_simdgroup_matrix();
 ...
 */
LITETVM_API const Op& simdgroup_load();
 ...
 *                      int col = 8, int row = 8, bool transpose_matrix = false);
 */
LITETVM_API const Op& simdgroup_store();
 ...
 */
LITETVM_API const Op& dma_start_group();
 ...
 */
LITETVM_API const Op& dma_end_group();
 ...
 */
LITETVM_API const Op& undef();

/*!
 * \brief Profiling intrinsic
 */
LITETVM_API const Op& start_profile_intrinsic();

/*!
 * \brief Profiling intrinsic
 */
LITETVM_API const Op& end_profile_intrinsic();
 ...
 */
LITETVM_API const Op& anylist_getitem();
 ...
 *       in call_packed and anylist_setitem_call_packed.
 */
LITETVM_API const Op& anylist_resetitem();
 ...
 */
LITETVM_API const Op& anylist_setitem_call_packed();

/*!
 * \brief Same as anylist_setitem_call_packed but use C calling convention.
 */
LITETVM_API const Op& anylist_setitem_call_cpacked();
 ...
 */
LITETVM_API const Op& get_active_lane_mask();

/*! \brief Annotate a predicate not be considered as target condition of loop partition. */
LITETVM_API const Op& ignore_loop_partition();

/*! \brief The kind of structure field info used in intrinsic */
enum class TVMStructFieldKind : int {
    // array head address
    kArrAddr,
    kArrData,
    kArrShape,
