...
#ifndef LITETVM_TIR_SCHEDULE_H
#define LITETVM_TIR_SCHEDULE_H
...
public:
   ...
   */
    LITETVM_API static Schedule Concrete(IRModule mod, support::LinearCongruentialEngine::TRandState seed,
   ...
   * 2) VerifyCachedFlags
   */
    LITETVM_API static Schedule Traced(IRModule mod, support::LinearCongruentialEngine::TRandState seed,
                                   int debug_mask, ScheduleErrorRenderLevel error_render_level,
                                   bool enable_check = true);
