...
#ifndef LITETVM_TIR_SCHEDULE_INSTRUCTION_H
#define LITETVM_TIR_SCHEDULE_INSTRUCTION_H
...
#define TVM_REGISTER_INST_KIND(InstructionKindName)               \
    TVM_STR_CONCAT(TVM_INST_KIND_REGISTER_VAR_DEF, __COUNTER__) = \
            ::litetvm::tir::InstructionKindRegEntry::RegisterOrGet(InstructionKindName).set_name()
...
#endif//LITETVM_TIR_SCHEDULE_INSTRUCTION_H
