 ...
 * \brief StmtVisitor.
 */
class LITETVM_API StmtVisitor : protected StmtFunctor<void(const Stmt&)> {
public:
 ...
 */
class LITETVM_API StmtMutator : protected StmtFunctor<Stmt(const Stmt&)> {
public:
    /*!
   * \brief Mutate stmt.
 ...
 */
LITETVM_API Stmt IRTransform(Stmt stmt, const runtime::PackedFunc& preorder,
 ...
 */
LITETVM_API void PostOrderVisit(const ObjectRef& node, std::function<void(const ObjectRef&)> fvisit);
 ...
 */
LITETVM_API Stmt Substitute(Stmt stmt, std::function<Optional<PrimExpr>(const Var& var)> vmap);
 ...
 * \return The result.
 */
LITETVM_API PrimExpr Substitute(PrimExpr expr, std::function<Optional<PrimExpr>(const Var& var)> vmap);
 ...
 */
LITETVM_API void PreOrderVisit(const ObjectRef& stmt_or_expr,
 ...
 * \return The result.
 */
LITETVM_API Stmt SubstituteWithDataTypeLegalization(Stmt stmt,
 ...
 * \return The result.
 */
LITETVM_API PrimExpr SubstituteWithDataTypeLegalization(
 ...
 */
LITETVM_API PrimFunc RenewDefs(const PrimFunc& func);
