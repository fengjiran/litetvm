...
#ifndef LITETVM_TIR_SCHEDULE_PRIMITIVE_H
#define LITETVM_TIR_SCHEDULE_PRIMITIVE_H
 ...
 */
LITETVM_API int32_t SampleInt(support::LinearCongruentialEngine::TRandState* rand_state,
 ...
 */
LITETVM_API int64_t SampleCategorical(support::LinearCongruentialEngine::TRandState* rand_state,
 ...
 */
LITETVM_API std::function<int32_t()> MakeMultinomialSampler(
 ...
 */
LITETVM_API std::vector<int64_t> SamplePerfectTile(
 ...
 */
LITETVM_API std::vector<int64_t> SamplePartitionedTile(
        support::LinearCongruentialEngine::TRandState* rand_state,//
 ...
 */
LITETVM_API tir::StmtSRef SampleComputeLocation(
 ...
 */
LITETVM_API Array<StmtSRef> Split(ScheduleState self, const StmtSRef& loop_sref,
 ...
 */
LITETVM_API Array<StmtSRef> LoopPartition(ScheduleState self, const StmtSRef& loop_sref,
                                          const Array<PrimExpr>& factors, bool preserve_unit_iters);
 ...
 */
LITETVM_API StmtSRef Merge(ScheduleState self, const Array<StmtSRef>& loop_srefs);
 ...
 */
LITETVM_API StmtSRef Fuse(ScheduleState self, const Array<StmtSRef>& loop_srefs,
 ...
 */
LITETVM_API void Reorder(ScheduleState self, const Array<StmtSRef>& ordered_loop_srefs);
 ...
 */
LITETVM_API void ReorderBlockIterVar(ScheduleState self, const StmtSRef& block_sref,
 ...
 */
LITETVM_API StmtSRef AddUnitLoop(ScheduleState self, StmtSRef sref);
 ...
 */
LITETVM_API void Parallel(ScheduleState self, const StmtSRef& loop_sref);
/*!
 ...
 */
LITETVM_API void Vectorize(ScheduleState self, const StmtSRef& loop_sref);
/*!
 ...
 */
LITETVM_API void Bind(ScheduleState self, const StmtSRef& loop_sref, const String& thread_axis);
/*!
 * \brief Unroll the input loop. It requires nothing
 * \param self The state of the schedule
 * \param loop_sref The loop to be unrolled
 */
LITETVM_API void Unroll(ScheduleState self, const StmtSRef& loop_sref);
 ...
 */
LITETVM_API StmtSRef CacheRead(ScheduleState self, const StmtSRef& block_sref, int read_buffer_index,
 ...
 * \return The cache stage block.
 */
LITETVM_API StmtSRef CacheWrite(ScheduleState self, const StmtSRef& block_sref, int write_buffer_index,
 ...
 * \return The cache stage block.
 */
LITETVM_API StmtSRef ReindexCacheRead(ScheduleState self, const StmtSRef& block_sref,
 ...
 * \return The cache stage block.
 */
LITETVM_API StmtSRef ReindexCacheWrite(ScheduleState self, const StmtSRef& block_sref,
 ...
 */
LITETVM_API Array<StmtSRef> CacheInplace(ScheduleState self, const StmtSRef& block_sref,
                                         int read_buffer_index, const String& storage_scope);
/*!
 ...
 * \return The cache stage block.
 */
LITETVM_API Array<StmtSRef> CacheIndex(ScheduleState self, const StmtSRef& block_sref,
 ...
 */
LITETVM_API StmtSRef ReIndex(ScheduleState self, const StmtSRef& block_sref, int buffer_index,
                             BufferIndexType buffer_index_type);

/******** Schedule: Data movement ********/

LITETVM_API StmtSRef ReadAt(ScheduleState self, const StmtSRef& loop_sref, const StmtSRef& block_sref,
                            int read_buffer_index, const String& storage_scope);

LITETVM_API StmtSRef WriteAt(ScheduleState self, const StmtSRef& loop_sref, const StmtSRef& block_sref,
                             int write_buffer_index, const String& storage_scope);
 ...
 */
LITETVM_API void ComputeAt(ScheduleState self, const StmtSRef& block_sref, const StmtSRef& loop_sref,
 ...
 * - Otherwise, `index` is a nonnegative number that indicates the insertion point
 */
LITETVM_API void ReverseComputeAt(ScheduleState self, const StmtSRef& block_sref,
 ...
 */
LITETVM_API void ComputeInline(ScheduleState self, const StmtSRef& block_sref);
/*!
 ...
 */
LITETVM_API void ReverseComputeInline(ScheduleState self, const StmtSRef& block_sref);
/******** Schedule: Reduction ********/
/*!
 ...
 */
LITETVM_API StmtSRef DecomposeReduction(ScheduleState self, const StmtSRef& block_sref,
 ...
 */
LITETVM_API StmtSRef RFactor(ScheduleState self, const StmtSRef& loop_sref, int factor_axis);
 ...
 */
LITETVM_API void StorageAlign(ScheduleState self, const StmtSRef& block_sref, int buffer_index,
 ...
 */
LITETVM_API void SetScope(ScheduleState self, const StmtSRef& block_sref, int buffer_index,
                          const String& storage_scope);
/*!
 ...
 */
LITETVM_API void UnsafeSetDType(ScheduleState self, const StmtSRef& block_sref, int buffer_index,
                                const String& dtype);
/*!
 ...
 */
LITETVM_API void SetAxisSeparator(ScheduleState self, const StmtSRef& block_sref, int buffer_index,
                                  BufferIndexType buffer_index_type,
 ...
 */
LITETVM_API StmtSRef Blockize(ScheduleState self, const StmtSRef& loop_sref, bool preserve_unit_iters);
 ...
 * \return The new block
 */
LITETVM_API StmtSRef Blockize(ScheduleState self, const Array<StmtSRef>& blocks,
 ...
 * \param preserve_unit_iters Whether or not to preserve unit iterators in block bindings
 */
LITETVM_API void Tensorize(ScheduleState self, const StmtSRef& block_or_loop_sref,
 ...
 */
LITETVM_API void Annotate(ScheduleState self, const StmtSRef& sref, const String& ann_key,
 ...
 * \param ann_key The annotation key
 */
LITETVM_API void Unannotate(ScheduleState self, const StmtSRef& sref, const String& ann_key);
 ...
 * guaranteed.
 */
LITETVM_API void TransformLayout(ScheduleState self, const StmtSRef& block_sref, int buffer_index,
 ...
 * \param index_map The transformation to apply.
 */
LITETVM_API void TransformBlockLayout(ScheduleState self, const StmtSRef& block_sref,
                                      const IndexMap& index_map);
 ...
 */
LITETVM_API StmtSRef DecomposePadding(ScheduleState self, const StmtSRef& block_sref,
                                      const StmtSRef& loop_sref);
 ...
 */
LITETVM_API void PadEinsum(ScheduleState self, const StmtSRef& block_sref,
 ...
 * \param write_buffer_index The index of the buffer in block's write region.
 */
LITETVM_API void RollingBuffer(ScheduleState self, const StmtSRef& block_sref, int write_buffer_index);
/******** Schedule: Misc ********/
 ...
 */
LITETVM_API void UnsafeHideBufferAccess(ScheduleState self, const StmtSRef& block_sref,
 ...
 */
LITETVM_API void AnnotateBufferAccess(ScheduleState self, const StmtSRef& block_sref, int buffer_index,
                                      BufferIndexType buffer_index_type, const IndexMap& index_map);
}// namespace tir
}// namespace litetvm

#endif//LITETVM_TIR_SCHEDULE_PRIMITIVE_H
