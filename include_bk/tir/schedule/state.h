...
#ifndef LITETVM_TIR_SCHEDULE_STATE_H
#define LITETVM_TIR_SCHEDULE_STATE_H
...
public:
   ...
   */
    LITETVM_API void Replace(const tir::StmtSRef& src_sref, const Stmt& tgt_stmt,
   ...
   */
    LITETVM_API void DebugVerify() const;
    ...
    LITETVM_API BlockInfo GetBlockInfo(const StmtSRef& block_sref) const;
    /*!
   ...
   */
    LITETVM_API void UpdateScopeBlockInfo(const Stmt& stmt);
    /*!
...
public:
   ...
   */
    LITETVM_API explicit ScheduleState(IRModule mod, int debug_mask = 0, bool enable_check = true);
...
#endif//LITETVM_TIR_SCHEDULE_STATE_H
