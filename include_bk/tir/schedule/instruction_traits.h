...
#ifndef LITETVM_TIR_SCHEDULE_INSTRUCTION_TRAITS_H
#define LITETVM_TIR_SCHEDULE_INSTRUCTION_TRAITS_H
...
TVM_ALWAYS_INLINE void UnpackedInstTraits<TTraits>::_SetInputs(const runtime::TVMArgsSetter& setter,
                                                               const Array<ObjectRef>& inputs) {
    constexpr size_t kNumInputs = TTraits::kNumInputs;
    CHECK_EQ(kNumInputs, inputs.size())
...
#endif//LITETVM_TIR_SCHEDULE_INSTRUCTION_TRAITS_H
