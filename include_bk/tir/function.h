...
#ifndef LITETVM_TIR_FUNCTION_H
#define LITETVM_TIR_FUNCTION_H
...
public:
   ...
   */
    LITETVM_API FuncType func_type_annotation() const;
...
public:
     ...
     */
    LITETVM_API PrimFunc(Array<Var> params, Stmt body, Type ret_type = VoidType(),
                         Map<Var, Buffer> buffer_map = Map<Var, Buffer>(),
...
public:
     ...
     */
    LITETVM_API explicit TensorIntrin(PrimFunc desc, PrimFunc impl);
     ...
     *         exists.
     */
    LITETVM_API static void Register(String name, TensorIntrin intrin, bool override = false);
     ...
     * false.
     */
    LITETVM_API static Optional<TensorIntrin> Get(String name, bool allow_missing = false);
