...
#ifndef LITETVM_RELAX_TRANSFORM_H
#define LITETVM_RELAX_TRANSFORM_H

#include "ir/transform.h"
#include "relax/dataflow_pattern.h"
...
using Pass = litetvm::transform::Pass;
using PassInfo = litetvm::transform::PassInfo;
using PassContext = litetvm::transform::PassContext;
using Function = litetvm::relax::Function;
using DataflowBlock = litetvm::relax::DataflowBlock;
 ...
 */
LITETVM_API Pass CreateFunctionPass(
        const runtime::TypedPackedFunc<Function(Function, IRModule, PassContext)>& pass_func,
        int opt_level, String name, Array<String> required, bool traceable = false);
 ...
 */
LITETVM_API Pass CreateDataflowBlockPass(
 ...
 * \return The Pass.
 */
LITETVM_API Pass ToNonDataflow();
 ...
 */
LITETVM_API Pass RemovePurityChecking();
 ...
 * \return The Pass.
 */
LITETVM_API Pass CallTIRRewrite();
 ...
 */
LITETVM_API Pass RewriteDataflowReshape();
 ...
 * \return The pass.
 */
LITETVM_API Pass StaticPlanBlockMemory();
 ...
 * \return The Pass.
 */
LITETVM_API Pass AttachGlobalSymbol();
 ...
 */
LITETVM_API Pass NormalizeGlobalVar();
 ...
 * \return The Pass.
 */
LITETVM_API Pass CanonicalizeBindings();
 ...
 */
LITETVM_API Pass EliminateCommonSubexpr(bool call_only = false);
 ...
 * \return The Pass.
 */
LITETVM_API Pass BindParams(String func_name, Map<ObjectRef, ObjectRef> params);
 ...
 * \return The Pass.
 */
LITETVM_API Pass BindSymbolicVars(Map<ObjectRef, PrimExpr> binding_map,
 ...
 * \return The Pass.
 */
LITETVM_API Pass LegalizeOps(Optional<Map<String, PackedFunc>> cmap, bool enable_warning = false);

/*!
 * \brief Propagate virtual device information.
 * \return The Pass.
 */
LITETVM_API Pass RealizeVDevice();
 ...
 * \return The Pass.
 */
LITETVM_API Pass AttachAttrLayoutFreeBuffers();
 ...
 * \return The Pass.
 */
LITETVM_API Pass SplitLayoutRewritePreproc();
 ...
 * \return The Pass.
 */
LITETVM_API Pass LiftTransformParams(Variant<Bool, Array<String>> shared_transform = Bool(false));
 ...
 * \return The Pass.
 */
LITETVM_API Pass UpdateVDevice(VDevice new_vdevice, int64_t index);

/*! \brief Expand tuple arguments to internal functions
 *
 * \return The Pass
 */
LITETVM_API Pass ExpandTupleArguments();

/*! \brief Remove unused parameters to internal functions
 *
 * \return The Pass
 */
LITETVM_API Pass RemoveUnusedParameters();

/*! \brief Remove unused outputs from internal functions
 *
 * \return The Pass
 */
LITETVM_API Pass RemoveUnusedOutputs();
 ...
 * \return The Pass.
 */
LITETVM_API Pass AnnotateTIROpPattern();
 ...
 * \return The Pass.
 */
LITETVM_API Pass FuseOps(int fuse_opt_level = -1);
 ...
 * \note ConvertToDataflow may need to be called first to provide dataflow blocks.
 */
LITETVM_API Pass Gradient(String func_name, Optional<Array<Var>> require_grads = NullOpt,
                          int target_index = 0);
 ...
 */
LITETVM_API Pass FuseOpsByPattern(const Array<FusionPattern>& patterns, bool bind_constants = true,
 ...
 * \return The Pass.
 */
LITETVM_API Pass MergeCompositeFunctions();
 ...
 * \return The Pass.
 */
LITETVM_API Pass RunCodegen(Optional<Map<String, Map<String, ObjectRef>>> target_options,
 ...
 * all functions.
 */
LITETVM_API Pass DecomposeOpsForInference(Optional<String> func_name);
 ...
 * all functions.
 */
LITETVM_API Pass DecomposeOpsForTraining(Optional<String> func_name);
 ...
 * \return The Pass.
 */
LITETVM_API Pass AlterOpImpl(const Map<String, tir::PrimFunc>& op_impl_map,
 ...
 */
LITETVM_API Pass ConvertLayout(Map<String, Array<String>> desired_layouts);
 ...
 * \return The Pass.
 */
LITETVM_API Pass ConvertToDataflow(int min_size = 2);
 ...
 * \return The Pass.
 */
LITETVM_API Pass DeadCodeElimination(Array<runtime::String> entry_functions = {});
 ...
 * \return The pass.
 */
LITETVM_API Pass DataflowUseInplaceCalls();
 ...
 */
LITETVM_API Pass ToMixedPrecision(const DataType& out_dtype,
 ...
 * graph capturing.
 */
LITETVM_API Pass RewriteCUDAGraph();
 ...
 * \return The Pass.
 */
LITETVM_API Pass FewShotTuning(int valid_count, bool benchmark);

}// namespace transform
}// namespace relax
}// namespace litetvm

#endif//LITETVM_RELAX_TRANSFORM_H
