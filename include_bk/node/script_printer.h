...
#ifndef SCRIPT_PRINTER_H
#define SCRIPT_PRINTER_H
...
public:
    ...
    /*! \brief Whether to show metadata. */
   ...
   */
    ...
    /*! \brief Whether to verbose print expressions. */
   ...
   */
    ...
    Array<String> GetBuiltinKeywords() const;
...
public:
    explicit PrinterConfig(const Map<String, ObjectRef>& config_dict = Map<String, ObjectRef>());
