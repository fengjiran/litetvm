...
public:
   ...
   */
    bool MatchRange(const Range& r) const;
   ...
   * \return The constructed set.
   */
    static IntSet FromRange(Range r);
    /*!
 ...
 */
Map<Var, IntSet> AsIntSet(const Map<Var, Range>& var_dom);
 ...
 */
LITETVM_API Optional<Array<IntSet>> EstimateRegionStrictBound(const Array<Range>& region,
 ...
 * \return NullOpt if the detection fails, or an array of arith::IntSet as the result of analysis
 */
LITETVM_API Optional<Array<IntSet>> EstimateRegionLowerBound(const Array<Range>& region,
                                                             const Map<Var, Range>& var_dom,
                                                             const PrimExpr& predicate,
                                                             Analyzer* analyzer);
 ...
 */
LITETVM_API Array<IntSet> EstimateRegionUpperBound(const Array<Range>& region,
                                                   const Map<Var, Range>& var_dom,
                                                   const PrimExpr& predicate,
                                                   Analyzer* analyzer);
